...
class ButterBarCollection(gtk.VBox):
  ...
  def add_bar(self, bar):
    assert isinstance(bar,ButterBar)
  ...
  def __getitem__(self,i):
    ...
    if isinstance(grp.get_children()[0], ButterBar):
...
if __name__ == "__main__" and True:
  ...
  # bb1
  bb = ButterBar("blah blah blah")
  bbc.add_bar(bb)

  # bb1
  bb = ButterBar("this is informational")
  ...
  # bb1
  bb = ButterBar("OMG you need to do somethnig")
